...
namespace Algorithm.BinarySeachTree
{
    /// <summary>
    /// 二分搜索树
    /// </summary>
    ...
    public class BinarySearchTree<E> where E :IComparable<E>
    {
        ...
        public void Add(E e)
        {
            if(_root==null) _root=new Node(e);
            else
            {
                Node cur = _root;
                Node parent = _root;
                ...
                if (parent.E.CompareTo(e) < 0) parent.Right=new Node(e);
                else if(parent.E.CompareTo(e) > 0) parent.Left=new Node(e);
            }
        ...
        private Node AddByRecursion(Node node,E e)
        {
            ...
            if (node.E.CompareTo(e) < 0) node.Right = AddByRecursion(node.Right,e);
            else if (node.E.CompareTo(e) > 0) node.Left = AddByRecursion(node.Left, e);
            return node;
        }
